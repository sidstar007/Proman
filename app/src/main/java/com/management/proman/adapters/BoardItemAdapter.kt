...
open class BoardItemAdapter(private val context: Context, private var list: ArrayList<Board>):
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            val boardImage = holder.itemView.findViewById<ImageView>(R.id.iv_board_image)
            Glide
                .with(context)
                .load(model.image)
                .centerCrop()
        ...
        val boardName = holder.itemView.findViewById<TextView>(R.id.tv_name)
        val createdBy = holder.itemView.findViewById<TextView>(R.id.tv_created_by)
